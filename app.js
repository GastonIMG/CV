...
// oculto el menu una vez que selecciono una acción
let links = document.querySelectorAll ("nav a");
for(var x= 0; x <links.length;x++) {
    links[x].onlick = function(){
        menu.style.display = "none";
        menu_visible = false;
    }
...
//comienzan en -1 porque no tienen ninguna pintada al iniciarse
let contadores = [-1,-1,-1,-1,-1,-1];
//esta varialble la voy a utilizar de bandera para saber si ya se ejecutó la animación
let entro =false;
...
//detecto el scroling el mouse para aplicar la animación de la barra
